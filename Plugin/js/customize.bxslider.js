$(document).ready(function(){
    $(".slider").bxSlider({
        ...
        // minSlides는 무조건 1 : 조작하지 말 것
        // maxslider에 문제가 생기면 width 100% 를 부여했을 가능성이 있음
        // sldierWidth에서 조절할 수 있음
        // slidermargin으로도 조절할 수 있음
        // 이 환경에서는 우리가 배운 css가 간섭이 될 수 있음 
        // moversldies 움직일 개수
        // shrinkItems:
